...
public class Parameter {
    ...
    public static int getIntValue(String parameter)throws IllegalArgumentException {
        // Return the value of the parameter as an integer.
        return Integer.parseInt(parameter.toUpperCase());
    }

    public static double getDoubleValue(String parameter)throws IllegalArgumentException {
        // Return the value of this parameter as a double.
        return Double.parseDouble(parameter.toUpperCase());
    }

    public static Parameter.Option getOptionValue(String parameter)throws IllegalArgumentException {
    ...
    public static Parameter.Color getColorValue(String parameter)throws IllegalArgumentException {
